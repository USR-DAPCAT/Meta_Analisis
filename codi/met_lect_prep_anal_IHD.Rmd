---
title: "Meta_Analisi.Associations of macrovascular complications(ISCHAEMIC HEART DISEASE)-IHD- with death in patients with diabetes hospitalized for Coronavirus disease(COVID-19). \\pkg{foo}"
...
* Meta_Analisi Associations of macrovascular(IHD) complications DM and Covid-19: UK,France,HM(Spain),Barcelona
...
base_dades<-readxl::read_excel(conductor,sheet = "base_dades_IHD")
...
```
## 3.1  	Meta-Analysis of Death/Uci/Imv~ Macrovascular disease -IHD- (unadjusted).
...
## Meta_Analisi Associations of macrovascular complications -IHD- with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Unadjusted model
...
## Meta_Analisi Associations of macrovascular complications -IHD- with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Unadjusted model
...
## Meta_Analisi Associations of macrovascular complications -IHD- with IMV in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Unadjusted model
...
meta1b<-meta::metagen(TE=ROR_covid1_imv$LOG_OR,
...
## 3.2  	Meta-Analysis of Death/Uci/Uci_Death/Imv ~ Macrovascular -IHD- disease + Age + Sex.
...
## Meta_Analisi Associations of macrovascular complications -IHD- with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex).
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Random effect model).
...
## Meta_Analisi Associations of macrovascular complications -IHD- with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex).
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Common effect model).
...
## Meta_Analisi Associations of macrovascular complications -IHD- with IMV in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex).
* In this  case, there is  not variability between the 2 studies, so we will accept the average effect of the 2 studies (Common effect model).
```{r analisis2c,include=TRUE}

meta2b<-meta::metagen(TE=ROR_covid2_imv$LOG_OR,
...
## 3.3  	Meta-Analysis of Death/Uci/Imv ~ Macrovascular disease -IHD- + Age + Sex + Hypertension + Type of Diabetes + Microvascular disease.
...
## Meta_Analisi Associations of macrovascular complications-IHD- with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease).
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Common effect model).
...
## Meta_Analisi Associations of macrovascular complications-IHD- with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease).
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Common effect model).
...
## Meta_Analisi Associations of macrovascular complications-IHD- with IMV in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease).
* In this  case, there is  not variability between the 2 studies, so we will accept the average effect of the 2 studies (Common effect model).
...
meta3b<-meta::metagen(TE=ROR_covid3_imv$LOG_OR,
...
## Meta_Analisi Associations of macrovascular complications-IHD- with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Meta-Analysis of Death ~ Macrovascular disease -IHD- + Age + Sex + Hypertension + Type of Diabetes + Microvascular disease + BMI + Etnia).
...
## Meta_Analisi Associations of macrovascular complications-IHD- with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Meta-Analysis of Uci ~ Macrovascular disease -IHD- + Age + Sex + Hypertension + Type of Diabetes + Microvascular disease + BMI + Etnia).
* In this  case, there is  not variability between the 3 studies, so we will accept the average effect of the 3 studies (Common effect model).
...
readxl::read_excel(conductor_codis2,col_types = "text")%>%dplyr::select(cod,Descripcio,agr,agr0,agr2)%>% filter(agr=="CI" | agr=="MI" | agr=="INSUF_CARD" )%>%dplyr::select(cod,agr)%>% knitr::kable(caption="ICD10 ISCHAEMIC HEART DISEASE Codes ")
