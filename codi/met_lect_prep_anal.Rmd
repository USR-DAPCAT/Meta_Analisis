...
**The Statistic I2 (Higgins & Thompson’s Statistic) and τ2 , tell us if there is a lot of variability (Heterogeneity) between the different studies of the Meta-analysis, or if the difference is only due to chance**   
...
* In this  case, there is no variability between the 3 studies, so we will accept the average effect of the 3 studies (Common effect model).
...
meta::forest(meta1,fontsize=9.2, boxsize=5)
...
meta::forest(meta2,fontsize=9.2, boxsize=5)
...
meta::forest(meta3,fontsize=9.2, boxsize=5)
