...
ROR_covid1_uci_death<-base_dades%>%filter(COUNTRY=="UK_MOD1_uci_death"       | COUNTRY=="FRANCE_MOD1_uci_death"   | COUNTRY=="HM_MOD1_uci_death"  | COUNTRY=="BCN_MOD1_uci_death" )%>%
  select(COUNTRY,LOG_OR,SE_OR)
ROR_covid2_uci_death<-base_dades%>%filter(COUNTRY=="UK_MOD2_uci_death"       | COUNTRY=="FRANCE_MOD2_uci_death"   | COUNTRY=="HM_MOD2_uci_death"  | COUNTRY=="BCN_MOD2_uci_death" )%>%
  select(COUNTRY,LOG_OR,SE_OR)
ROR_covid3_uci_death<-base_dades%>%filter(COUNTRY=="FRANCE_MOD3_uci_death"   | COUNTRY=="HM_MOD3_uci_death"       | COUNTRY=="BCN_MOD3_uci_death" )%>%
  select(COUNTRY,LOG_OR,SE_OR)
ROR_covid4_uci_death<-base_dades%>%filter(COUNTRY=="UK_MOD4_uci_death"       | COUNTRY=="FRANCE_MOD4_uci_death"   | COUNTRY=="BCN_MOD4_uci_death" )%>%select(COUNTRY,LOG_OR,SE_OR)
ROR_covid5_uci_death<-base_dades%>%filter(COUNTRY=="UK_MOD4_uci_death"       | COUNTRY=="FRANCE_MOD4_uci_death"   | COUNTRY=="BCN_MOD4_uci_death" | COUNTRY=="HM_MOD3_uci_death"   )%>%
  select(COUNTRY,LOG_OR,SE_OR)
...
* BCN.Model       Uci or death ~ Macrovascular disease (unadjusted).
...
* BCN.Model       Uci or death ~ Macrovascular disease + Age + Sex.
...
* BCN.Model       Uci or death ~ Macrovascular disease + Age + Sex + Hypertension + "--------------" + "---------------------"
...
## Meta_Analisi Associations of macrovascular complications with Uci or death in patients with diabetes hospitalized for Coronavirus disease(COVID-19)
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 3 studies (Common effect model).
...
* BCN.Model       Uci or death ~ Macrovascular disease + Age + Sex + "-----------"+ "--------------" + Microvascular disease + BMI + Etnia.



## Meta_Analisi Associations of macrovascular complications with death in patients with diabetes hospitalized for Coronavirus disease(COVID-19)
* In this  case, there is  not variability between the 3 studies, so we will accept the average effect of the 4 studies (Common effect model).
...
## Meta_Analisi Associations of macrovascular complications with Uci or death in patients with diabetes hospitalized for Coronavirus disease(COVID-19)
* In this  case, there is  not variability between the 3 studies, so we will accept the average effect of the 4 studies (Random effect model).
