...
ROR_covid2_uci<-base_dades%>%filter(COUNTRY=="UK_MOD2_uci"       | COUNTRY=="FRANCE_MOD2_uci"   | COUNTRY=="HM_MOD2_uci"  | COUNTRY=="BCN_MOD2_uci" )%>%
  select(COUNTRY2,LOG_OR,SE_OR)
ROR_covid3_uci<-base_dades%>%filter(COUNTRY=="UK_MOD3_uci"       | COUNTRY=="FRANCE_MOD3_uci"   | COUNTRY=="HM_MOD3_uci"  | COUNTRY=="BCN_MOD3_uci" )%>%
  select(COUNTRY2,LOG_OR,SE_OR)
...
```
## 3.1  	Meta-Analysis of Death/Uci/Uci_Death/Imv~ Macrovascular disease (unadjusted).
...
## Meta_Analisi Associations of macrovascular complications with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Unadjusted model
...
#meta::forest(meta1,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.2, 5))
...
## Meta_Analisi Associations of macrovascular complications with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Unadjusted model
...
meta::forest(meta1b,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.random"),xlim=c(0.1, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))


```

## Meta_Analisi Associations of macrovascular complications with UCI or DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Unadjusted model
...
meta1c<-meta::metagen(TE=ROR_covid1_uci_death$LOG_OR,
               ...
               studlab = ROR_covid1_uci_death$COUNTRY2,
               sm = 'OR',
...
meta::forest(meta1c,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.random"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))


```


## Meta_Analisi Associations of macrovascular complications with IMV in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Unadjusted model
...
meta1d<-meta::metagen(TE=ROR_covid1_imv$LOG_OR,
               ...
               studlab = ROR_covid1_imv$COUNTRY2,
               sm = 'OR',
...
meta::forest(meta1d,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))


```


## 3.2  	Meta-Analysis of Death/Uci/Uci_Death/Imv ~ Macrovascular disease + Age + Sex.
...
## Meta_Analisi Associations of macrovascular complications with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex).
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Random effect model).
...
meta::forest(meta2,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.random"),xlim=c(0.2, 5),
...
## Meta_Analisi Associations of macrovascular complications with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex).
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Common effect model).
...
## Meta_Analisi Associations of macrovascular complications with UCI or DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex).
* In this  case, there is  not variability between the 3 studies, so we will accept the average effect of the 3 studies (Random effect model).
...
meta2c<-meta::metagen(TE=ROR_covid2_uci_death$LOG_OR,
               ...
               studlab = ROR_covid2_uci_death$COUNTRY2,
               sm = 'OR',
               title = "Meta_Analisi Associations of macrovascular complications with Uci or death in patients with diabetes hospitalized for Coronavirus disease(COVID-19)")


meta::forest(meta2c,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.random"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))
...
## Meta_Analisi Associations of macrovascular complications with IMV in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex).
* In this  case, there is  not variability between the 2 studies, so we will accept the average effect of the 2 studies (Common effect model).
...
meta2d<-meta::metagen(TE=ROR_covid2_imv$LOG_OR,
               ...
               studlab = ROR_covid2_imv$COUNTRY2,
               sm = 'OR',
               title = "Meta_Analisi Associations of macrovascular complications with imv in patients with diabetes hospitalized for Coronavirus disease(COVID-19)")


meta::forest(meta2d,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))
...
## 3.3  	Meta-Analysis of Death/Uci/Uci_Death/Imv ~ Macrovascular disease + Age + Sex + Hypertension + Type of Diabetes + Microvascular disease.
...
## Meta_Analisi Associations of macrovascular complications with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease).
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Random effect model).
...
meta::forest(meta3,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.random"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))



```

## Meta_Analisi Associations of macrovascular complications with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease).
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Common effect model).
...
## Meta_Analisi Associations of macrovascular complications with UCI or DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease).
* In this  case, there is  not variability between the 2 studies, so we will accept the average effect of the 2 studies (Common effect model).
...
meta3c<-meta::metagen(TE=ROR_covid3_uci_death$LOG_OR,
               ...
               studlab = ROR_covid3_uci_death$COUNTRY2,
               sm = 'OR',
               title = "Meta_Analisi Associations of macrovascular complications with Uci or death in patients with diabetes hospitalized for Coronavirus disease(COVID-19)")


meta::forest(meta3c,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))



```

## Meta_Analisi Associations of macrovascular complications with IMV in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease).
* In this  case, there is  not variability between the 2 studies, so we will accept the average effect of the 2 studies (Common effect model).
...
meta3d<-meta::metagen(TE=ROR_covid3_imv$LOG_OR,
               ...
               studlab = ROR_covid3_imv$COUNTRY2,
               sm = 'OR',
               title = "Meta_Analisi Associations of macrovascular complications with imv in patients with diabetes hospitalized for Coronavirus disease(COVID-19)")


meta::forest(meta3d,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))
...
## 3.4  	Meta-Analysis of Death/Uci/Uci_Death/Imv ~ Macrovascular disease + Age + Sex + Hypertension + Type of Diabetes + Microvascular disease+BMI + Etnia.
...
## Meta_Analisi Associations of macrovascular complications with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease + BMI + Etnia).
...
meta::forest(meta4,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.01, 22),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))


```


## Meta_Analisi Associations of macrovascular complications with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease + BMI + Etnia).
* In this  case, there is  not variability between the 3 studies, so we will accept the average effect of the 3 studies (Common effect model).
...
meta::forest(meta4b,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.01, 6),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))


```


## Meta_Analisi Associations of macrovascular complications with UCI or DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Ajusted model(Age + Sex + Hypertension + Type of Diabetes + Microvascular disease + BMI + Etnia).
...
meta4c<-meta::metagen(TE=ROR_covid4_uci_death$LOG_OR,
               ...
               studlab = ROR_covid4_uci_death$COUNTRY2,
               sm = 'OR',
               title = "Meta_Analisi Associations of macrovascular complications with Uci or death in patients with diabetes hospitalized for Coronavirus disease(COVID-19)")


meta::forest(meta4c,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.random"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))
...
## Meta_Analisi Associations of macrovascular complications with DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Other ajusted model.
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Common effect model).
...
meta5<-meta::metagen(TE=ROR_covid5$LOG_OR,
               ...
               studlab = ROR_covid5$COUNTRY2,
               sm = 'OR',
               title = "Meta_Analisi Associations of macrovascular complications with death in patients with diabetes hospitalized for Coronavirus disease(COVID-19)")


meta::forest(meta5,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))



```

## Meta_Analisi Associations of macrovascular complications with UCI in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Other ajusted model.
* In this  case, there is  not variability between the 4 studies, so we will accept the average effect of the 4 studies (Common effect model).
...
meta5b<-meta::metagen(TE=ROR_covid5_uci$LOG_OR,
               ...
               studlab = ROR_covid5_uci$COUNTRY2,
               sm = 'OR',
               title = "Meta_Analisi Associations of macrovascular complications with Uci in patients with diabetes hospitalized for Coronavirus disease(COVID-19)")


meta::forest(meta5b,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.fixed"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))
...
## Meta_Analisi Associations of macrovascular complications with UCI or DEATH in patients with diabetes hospitalized for Coronavirus disease(COVID-19).Other ajusted model.
* In this  case, there is  not variability between the 3 studies, so we will accept the average effect of the 3 studies (Random effect model).
...
meta5c<-meta::metagen(TE=ROR_covid5_uci_death$LOG_OR,
               ...
               studlab = ROR_covid5_uci_death$COUNTRY2,
               sm = 'OR',
               title = "Meta_Analisi Associations of macrovascular complications with Uci or death in patients with diabetes hospitalized for Coronavirus disease(COVID-19)")


meta::forest(meta5c,fontsize=8.2, boxsize=5, col.square="black", hetstat=TRUE,leftcols="studlab",rightcols=c("effect", "ci","w.random"),xlim=c(0.2, 5),squaresize=0.5,plotwidth=unit(9, "cm"),colgap=unit(3, "mm"))
